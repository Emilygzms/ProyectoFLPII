 ...
 * @author Frank
 */
@WebServlet(name = "ServletGuardar", urlPatterns = {"/ServletGuardar","/grabarListaCarrito"})
public class ServletGuardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(path.equals("/grabarListaCarrito")){
                ...
                //request.setAttribute("listarReserva",ReservaDAO.listar());
