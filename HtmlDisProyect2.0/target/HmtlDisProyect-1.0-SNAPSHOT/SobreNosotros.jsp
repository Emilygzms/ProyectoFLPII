...
.col-md-10 {
    ...
    <main>
            ...
            <div class="col-xs-12 col-md-6">
              <div class="about-text">
                ...
                <p style="text-align:justify">
                    Los distritos de Punta Hermosa y San Bartolo (Lima) son lugares muy concurridos durante gran parte del año, en especial en el verano, fines de semana y fechas como Semana Santa, esto se da gracias a la cantidad de bañistas y turistas que vistan las playas, el lugar posee una gran cantidad de restaurantes de los cuales destacan las cevicherías. 
                    >En el restaurante D’CARLOS los precios van de acuerdo con el servicio y la calidad de los platillos que se ofrecen. Además, tienen adaptado correctamente ambientes para mejorar la atención a sus clientes
                </p>
              </div>
        ...
        <div class="overlay">
          <div class="container">
            <div class="col-md-10 col-md-offset-1 section-title">
              ...
              <p style="text-align: justify">También contamos con un buen ambiente tanto en el salón como en los exteriores.</p>
            </div>
            <div id="row">
        ...
        <div class="overlay">
          <div class="container">
            <div class="col-md-10 col-md-offset-1 section-title">
              <h2>¿Cómo surgió el restaurante?</h2>
              <hr>
              <p style="text-align: justify">
                  A finales del año 2019, cuando carlos estaba terminando el primer ciclo de la universidad, decidió abrir un restaurante en el distrito de San Bartolo.
                  Esto fue debido a que la mayoría de la familia materna del señor Carlos se dedica al rubro de los restaurantes, es así como el señor Carlos decidió poner en marcha su emprendimiento.
              </p>
              <p style="text-align: justify">
                  El restaurante tuvo un gran éxito, fue acogiendo clientes rápidamente y se posicionó como uno de los favoritos en el distrito.
                    Si bien es cierto que la temporada de verano del 2020 se vio interrumpida por la pandemia del COVID-19, al retornar a trabajar siguió con gran éxito.
